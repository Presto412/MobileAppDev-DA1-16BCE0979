...
public class PlanetRecyclerAdapter extends RecyclerView.Adapter<PlanetRecyclerAdapter.PlanetHolder> {

    private Context context;
    private ArrayList<Planet> planets;

    public PlanetRecyclerAdapter(Context context, ArrayList<Planet> planets) {
    ...
    public PlanetHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_row_recyclerview, parent, false);
