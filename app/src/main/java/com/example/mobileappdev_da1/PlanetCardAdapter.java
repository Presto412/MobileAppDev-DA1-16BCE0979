...
public class PlanetCardAdapter extends RecyclerView.Adapter<PlanetCardAdapter.PlanetHolder> {

    private Context context;
    private ArrayList<Planet> planets;

    public PlanetCardAdapter(Context context, ArrayList<Planet> planets) {
